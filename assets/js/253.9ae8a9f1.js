...
var mermaid_934d9bea = __webpack_require__(6294);
...
/* harmony export */ });
/* harmony import */ var _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6294);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6312);
/* harmony import */ var _createText_aebacdfe_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3520);
...
/* harmony export */ });
/* harmony import */ var _flowDb_170db09d_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7102);
/* harmony import */ var _styles_b966c4ae_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7584);
/* harmony import */ var _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6294);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6312);
...
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7046);
...
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3765);
/* harmony import */ var _edges_80f1ebb6_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1609);
/* harmony import */ var _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6294);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(697);
/* harmony import */ var _createText_aebacdfe_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3520);
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
  extractor(graph, 0);
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
      ...
      _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(clusterGraph));
      _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
    } else {
      _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
...
const recursiveRender = async (_elem, graph, diagramtype, id, parentCluster) => {
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph), parentCluster);
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph));
  let diff = 0;
...
const render = async (elem, graph, markers, diagramtype, id) => {
  ...
  clear();
  clear$1();
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph)));
  adjustClustersAndEdges(graph);
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .M(graph)));
...
var index_67a42d7d = __webpack_require__(2398);
// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/dagre-js/label/add-html-label.js
var add_html_label = __webpack_require__(8265);
...
const channel = (color, channel) => {
    return utils/* default */.A.lang.round(dist_color/* default */.A.parse(color)[channel]);
};
/* EXPORT */
...
const addEdges = function(edges, g, diagObj) {
  ...
  edges.forEach(function(edge) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_934d9bea.n)(edge.interpolate, src/* curveLinear */.lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_934d9bea.n)(edges.defaultInterpolate, src/* curveLinear */.lUB);
    } else {
      edgeData.curve = (0,mermaid_934d9bea.n)(conf.curve, src/* curveLinear */.lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  ...
  keys.forEach(function(key) {
    ...
    if (vertex.link) {
      const node = (0,src/* select */.Ltv)("#" + id + ' [id="' + key + '"]');
      if (node) {
